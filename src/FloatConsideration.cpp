...
FloatConsideration::FloatConsideration(const float min_value, const float max_value, const float test_value)
	:m_minValue(min_value), m_maxValue(max_value), m_testValue(test_value)
{
}
